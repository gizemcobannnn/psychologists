...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-row w-full gap-40 justify-between items-center m-auto">
        ...
        <div className="top-20 right-40 relative w-[400px] h-[400px] ">
            <img src={mainPhoto} alt="main photo"  className=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
            <img src={questionmark} alt="questionmark" className="w-8 h-8 p-1 absolute top-50 -left-5 bg-green-500 rounded-lg rotate-[-15deg]" />
