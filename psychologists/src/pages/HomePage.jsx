...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col justify-center pt-25 md:flex md:flex-row md:gap-20 md:w-full  md:justify-around md:items-center md:m-auto ">
        <div className="relative left-7 flex flex-col w-[600px] gap-8 justify-center items-start mt-15 md:left-2 lg:-left-20">
        ...
        <div className="-right-2 mt-8 mb-7 relative min-w-[650px] md:min-w-[400px] md:w-[500px] h-[500px]  md:top-0 md:-right-5 lg:right-5 lg:top-0 xl:right-15 lg:max-w-[450px] ">
            ...
            <div className='flex justify-center items-center flex-row p-3 gap-3 bg-primary absolute bottom-9 left-10  md:bottom-9 md:-left-20 rounded-xl'>
