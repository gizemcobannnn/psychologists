...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col justify-center p-4 md:flex md:flex-row md:gap-20 md:w-full  md:justify-around md:items-center md:m-auto ">
        ...
        <div className="-right-2 mt-8 relative min-w-[650px] md:min-w-[400px] md:w-[500px] h-[500px]  md:top-0 md:-right-5 lg:right-5 lg:top-0 xl:right-30 lg:max-w-[450px] ">
