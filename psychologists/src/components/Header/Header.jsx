...
export default function Header() {
  ...
  useEffect(() => {
    ...
    return (
      <>
        <header className="fixed top-0 left-0 w-screen z-50 pl-56 flex flex-row justify-between items-center min-w-[570px] pr-5 pt-3 pb-3 border-b border-slate-300 bg-[#FBFBFB]">
          <div>
