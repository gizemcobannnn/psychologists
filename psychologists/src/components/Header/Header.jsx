...
export default function Header() {
    ...
    return (
        <>
            ...
            {isRegModelOpen && (<Register closeModal={() => setIsRegModelOpen(false)} />)}
            {isLogModelOpen && (<Login closeModal={() => setIsLogModelOpen(false)} />)}
            {isLogoutModelOpen && (<Logout closeModal={() => setIsLogoutModelOpen(false)} />)}
        </>
    )
}